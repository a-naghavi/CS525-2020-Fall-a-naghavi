...
(* ****** A ****** *)
//
val T1Pnil: type1 // nil
//
val T1Pint: type1 // int
//
val T1Pbool: type1 // bool
//
val T1Pstring: type1 // string
//
(* ****** A ****** *)
fun tpext_new(): tpext
...
(* ****** A ***** *)
fun
t1var_make(name: t0var,tp:type1):t1var
(* ****** A ***** *)
(* ****** ****** *)
...
fun
t1var_set_type1
(t1v0: t1var,tp:type1): void

fun
t1var_get_name
(t1v0: t1var): t0var
overload .name with t1var_get_name
(* ****** A ****** *)
...
fun t1pgm_tinfer(t1pgm): type1
fun t1dcl_tinfer(t1dcl): void
fun t1erm_tinfer(t1erm): type1
...
( env0
: s0env
, t0v1: t0var, tp1: type1): s0env
//
fun
s0env_search
( env0
: s0env, t0v1: t0var): myoptn(type1)
